...
from self_play import value_space as vs  # noqa: E402
...
def test_trainer_backstop_catches_corrupted_value(tmp_path):
    ...
    import torch
    from state_encoder import (get_state_dim, get_action_dim, get_gimmick_dim,
                               get_state_layout_version)
    from bc_model import BCPolicy
    from self_play.actor_critic import ActorCritic
    from self_play.collector import TrajectoryCollector
    from self_play.reward import place_terminal_reward
    from self_play.trainer import PPOTrainer, TrainConfig
